...
def extract_text():
    file = filedialog.askopenfile(parent=root, mode="rb", title= "Choose PDF File")
    if file != None:
...
def Application(root):
    root.geometry('{}x{}'.format(700, 600))   #700 x600
    ...
    frame1 = Frame(root, width=  500, height=200, bg = "yellow")

    #Frame2

    frame2 = Frame(root, width=500, height=450, bg="green")
    ...
    btn = Button(frame2, text= "Select PDF File", activebackground= "red", command=extract_text(), padx="70", pady="10", fg="white", bg = "black", font= "Arial 12")
    ...
    rate = Entry(frame2, text= "200", fg = "yellow", bg="blue", font= "Arial 12")
    ...
    submitBtn = Button(frame2, text= "Play PDF File", command= speack_text, activebackground= "red", padx="60", pady="10", fg="white", bg = "black", font= "Arial 12")

    submitBtn.grid(row=4, column=0, pady=65)

    stopBtn = Button(frame2, text= "Stop Playing", command= stop_playing, activebackground= "red", padx="60", pady="10", fg="white", bg = "black", font= "Arial 12")

    stopBtn.grid(row=4, column=1, pady=65)



if __name__ == "__main__": # Works like the Main function and this will control the flow of our code
